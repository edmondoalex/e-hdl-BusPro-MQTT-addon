...
class Sensor(Device):
    ...
    def _telegram_received_cb(self, telegram):
        if telegram.operate_code == OperateCode.ReadSensorStatusResponse:
            # payload: [success, temperature, brightness_high, brightness_low, ...]
            # brightness is a 16-bit value (high<<8 | low)
            ...
            # Some firmwares always send success_or_fail=248; don't gate brightness on it.
